...
- May 2023: Landry was invited to give a talk at the [Colloque IRL Frontières Quantiques](https://irllfqparis2023.sciencesconf.org/) at Université Paris Cité. Lovely boat cruise on the Seine in excellent company.
<div style="text-align: center;">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/news/IRLBateauMouche.jpeg" width="400">
</div>
...
- Sep 2021: Official start of the [EU-funded FERMIcQED project](https://cordis.europa.eu/project/id/947707)!
- July 2021: Congrats to Ambroise for his paper published in [Physical Review X](https://journals.aps.org/prx/abstract/10.1103/PhysRevX.11.031008) on a dc-Biased Josephson Junction generating two-modes entanglement.
...
- May 2021: Congrats to JD & Landry for their back-to-back papers published in Physical Review Research ([013288](https://journals.aps.org/prresearch/abstract/10.1103/PhysRevResearch.3.013288) & [013289](https://journals.aps.org/prresearch/abstract/10.1103/PhysRevResearch.3.013289)) on Weyl Josephson circuits.
...
- Sep 2020: Congrats to JD who was awarded a young researcher grant from [ANR](https://anr.fr/Projet-ANR-20-CE47-0003).
- Sep 2020: Landry was awarded an [ERC Starting Grant](https://cordis.europa.eu/project/id/947707) for the FERMIcQED project! → [X-News](https://www.polytechnique.edu/en/news/landry-bretheau-manipulate-condensed-matter-single-fermion-level)
- July 2020: We measured quantum limited amplification using a SNAIL from Zaki.
- Jun 2020: Congrats to JD for his paper published in [SciPost Physics Core](https://scipost.org/SciPostPhysCore.2.2.009) on the Scattering description of Andreev molecules.
...
- Aug 2019: Congrats to JD for his paper published in [Nano Letters](https://pubs.acs.org/doi/10.1021/acs.nanolett.9b02686) on Nonlocal Josephson effect in Andreev molecules.
- Aug 2019: New paper by JD & co published in [Physical Review Applied](https://journals.aps.org/prapplied/abstract/10.1103/PhysRevApplied.12.024034) on Injection Locking and Parametric Locking in a Superconducting Circuit.
