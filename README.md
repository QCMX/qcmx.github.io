...
# Editing
## GitHub workflow
There are two repositories, the [main website](https://github.com/QCMX/qcmx.github.io) and a [test website](https://github.com/QCMX/website). Each of them deploys a webpage via GitHub Pages to https://qcmx.github.io and https://qcmx.github.io/website. The domain `qcmx.fr` points to the main site.
...
The easiest way to edit content is directly on GitHub in the [test repository](https://github.com/QCMX/website) and committing to the `gh-pages` branch.  After about a minute, the changes become visible on https://qcmx.github.io/website
...
**Don't skip over putting descriptions and [helpful captions for disabled people](https://accessibility.huit.harvard.edu/describe-content-images) and credit attributes for pictures.**
